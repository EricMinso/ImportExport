...
namespace Import_Export_CSV
{
    public class GestionnaireBD
    {
        ...
        public void ImporterTableBD( string _strNomTable, DataTable _tampon, DataGridView _dataGridViewAColorer, AssociationChampsBDTampon _association, RunWorkerCompletedEventHandler événementTâcheTerminée)
        {
            ...
            DémarrerBackgroundWork(new DoWorkEventHandler(BGWorkImporterTableBD), événementTâcheTerminée);
        }
        ...
        private void BGWorkImporterTableBD(object sender, DoWorkEventArgs doWorkEventArgs)
        {
            ...
            GestionnaireDesTâches.addTitle("Enregistrement dans la table " + this.dtTampon.TableName);
            ...
            try
            {
                ...
                foreach (DataRow ligne in this.dtTampon.Rows)
                {
                    ...
                    indexLigne++;
                    newPourcentage = (int)((100 * indexLigne) / (this.dtTampon.Rows.Count + 1));
                    ...
                    if (GestionnaireDesTâches.ArrêtTâcheDemandé || backgroundWorker.CancellationPending)
                    {
        ...
        private void BGWorkExporterTouteLaBD( object sender, DoWorkEventArgs doWorkEventArgs )
        {
            ...
            int compteurEnregistrements = 0;
            long nombreTotalEnregistrements = 0;
            int oldPourcentage = 0;
            int newPourcentage = 0;

            GestionnaireDesTâches.addTitle("Exporter Toute La BD ");
            ...
            foreach( string strNomTable in listeDesTables )
            {
                ...
                try
                {
                    ...
                    GestionnaireDesTâches.addMessage("Fichier exporté :\n" + strFichier);
                }
                catch (Exception exception)
                {
                    GestionnaireDesTâches.addException(
        ...
        private void BGWorkImporterTouteLaBD(object sender, DoWorkEventArgs doWorkEventArgs)
        {
            ...
            GestionnaireDesTâches.addTitle("Importer Toute La BD ");
            ...
            for(indexTable=0; indexTable<this.assoTablesBDFichiersImport.TablesBD.Count; indexTable++ )
            {
                try
                {
                    ...
                    {
                        GestionnaireDesTâches.addMessage("Import de "+strNomTableBD+" ignoré : pas de fichier" );
                        continue;
                    }
                    GestionnaireDesTâches.addMessage("Import de "+strNomTableBD+" depuis "+strNomFichierImport+" - association via : "+strNomFichierAssociation);
        ...
        private void DémarrerBackgroundWork(DoWorkEventHandler work,RunWorkerCompletedEventHandler événementTâcheTerminée)
        {
        ...
        { 
            GestionnaireDesTâches.définirPourcentageTâche( e.ProgressPercentage ); 
        }
